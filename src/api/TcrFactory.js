function getFactory(web3, account, contractAddress) {
  const abi = [{
  ...
  // const TcrFactoryContract = web3.eth.contract(abi, '0x73f24e09486db7e69705f465832be91b13e67917')
  // const TcrFactory = TcrFactoryContract.at('0x73f24e09486db7e69705f465832be91b13e67917')

  const TcrFactoryContract = web3.eth.contract(abi, contractAddress)
  const TcrFactory = TcrFactoryContract.at(contractAddress)
